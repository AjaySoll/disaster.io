  ...
  return (
    <section className="relative overflow-hidden border-b border-bg-line">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-16 pb-12 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-bg-line bg-bg-panel/60 mb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
        {presets.map((p) => (
          ...
          >
            ...
            <div className="mt-1 font-mono text-[10px] text-ink-mute leading-snug line-clamp-2">
              {p.summary}
            </div>
          </button>
        ))}
